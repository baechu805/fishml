...
def add_prediction_column(csv_file_path='/home/joo/code/fishmlserv/note/modeldata.csv'):
    """
...
def add_prediction_column_api(csv_file_path='/home/joo/code/fishmlserv/note/modeldata.csv'):
    """
    CSV 파일의 데이터를 읽어와 각 행에 대한 예측 결과를 새로운 컬럼에 추가합니다.
